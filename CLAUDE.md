...
- **Pagina opera (2026-07-17)**: foto in carosello (frecce + miniature cliccabili, PhotoSwipe invariato); via la riga "Opera originale · pezzo unico", anno e tecnica; prezzi in font normale (non più font-hand); in fondo sezione "Potrebbero piacerti anche" (bestseller prima, ordine mescolato a ogni visita).
